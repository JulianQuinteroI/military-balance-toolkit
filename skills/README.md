...
```bash
export MB2026_HOME="/ruta/donde/clonaste/military-balance-toolkit"
...
- Para la orden `calco`, el skill `nato-symbology` debe estar instalado en
  `~/.claude/skills/nato-symbology`. No forma parte de este repositorio.
